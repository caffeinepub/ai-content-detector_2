...
export class Backend implements backendInterface {
    ...
    async analyzeFile(arg0: string, arg1: string, arg2: string, arg3: string): Promise<ScanRecord> {
        if (this.processError) {
            try {
                const result = await this.actor.analyzeFile(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async analyzeText(arg0: string, arg1: string): Promise<ScanRecord> {
        if (this.processError) {
            try {
    ...
    async clearHistory(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async deleteScan(arg0: string, arg1: bigint): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteScan(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDailyCount(arg0: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getDailyCount(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getHistory(arg0: string): Promise<Array<ScanRecord>> {
        if (this.processError) {
            try {
